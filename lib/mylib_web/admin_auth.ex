defmodule MylibWeb.AdminAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_mylib_web_admin_remember_me"
  ...
  the current_admin:
      ...
      defmodule MylibWeb.PageLive do
        ...
        on_mount {MylibWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{MylibWeb.AdminAuth, :ensure_authenticated}] do
